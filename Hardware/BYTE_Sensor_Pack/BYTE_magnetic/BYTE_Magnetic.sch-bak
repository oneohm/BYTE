...
U 1 1 612D16A6
P 760 1555
F 0 "J1" H 678 1030 50  0000 C CNN
F 1 "PCB" H 678 1121 50  0000 C CNN
F 2 "BYTE_Sensors:Magnetic_PCB" H 760 1555 50  0001 C CNN
F 3 "~" H 760 1555 50  0001 C CNN
	1    760  1555
	-1   0    0    -1  
$EndComp
...
Wire Wire Line
	2020 1360 2725 1360
Text Label 2025 1745 0    50   ~ 0
ADD1
Text Label 2025 1845 0    50   ~ 0
ADD0
$Comp
L power:GND #PWR0114
U 1 1 613D3874
P 2735 1970
F 0 "#PWR0114" H 2735 1720 50  0001 C CNN
F 1 "GND" H 2740 1797 50  0000 C CNN
F 2 "" H 2735 1970 50  0001 C CNN
F 3 "" H 2735 1970 50  0001 C CNN
	1    2735 1970
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	2025 1845 2735 1845
Connection ~ 2735 1845
Wire Wire Line
	2735 1845 2735 1745
Text Label 2020 1460 0    50   ~ 0
INT
Wire Wire Line
	2725 1215 2725 1360
$Comp
...
U 1 1 613F62D2
P 2980 1115
F 0 "R3" H 2845 1150 50  0000 L CNN
F 1 "2.2K" H 2770 1080 50  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric" H 2980 1115 50  0001 C CNN
F 3 "~" H 2980 1115 50  0001 C CNN
	1    2980 1115
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 613F6CA2
P 2980 975
F 0 "#PWR0115" H 2980 825 50  0001 C CNN
F 1 "+3.3V" H 2995 1148 50  0000 C CNN
F 2 "" H 2980 975 50  0001 C CNN
F 3 "" H 2980 975 50  0001 C CNN
	1    2980 975 
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	2020 1460 2980 1460
$Comp
L magnetic_sensor:Si7217-B-01-IV U3
U 1 1 6135E33F
P 4565 1190
F 0 "U3" H 5315 1455 50  0000 C CNN
F 1 "Si7217-B-01-IV" H 5315 1364 50  0000 C CNN
F 2 "BYTE_Sensors:SOT95P275X125-5N" H 5915 1290 50  0001 L CNN
F 3 "" H 5915 1190 50  0001 L CNN
F 4 "Si7217-B-01-IV" H 5915 790 50  0001 L CNN "manf#"
	1    4565 1190
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	8620 2435 8620 2490
$Comp
L BYTE_Magnetic-rescue:DRV2605YZFR-capacitive_sensor U2
U 1 1 6135A3F0
P 8020 1735
...
U 1 1 6136E6C8
P 6260 1010
F 0 "#PWR0101" H 6260 860 50  0001 C CNN
F 1 "+3.3V" H 6275 1183 50  0000 C CNN
F 2 "" H 6260 1010 50  0001 C CNN
F 3 "" H 6260 1010 50  0001 C CNN
	1    6260 1010
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 613708CF
P 6860 975
F 0 "#PWR0109" H 6860 825 50  0001 C CNN
F 1 "+3.3V" H 6875 1148 50  0000 C CNN
F 2 "" H 6860 975 50  0001 C CNN
F 3 "" H 6860 975 50  0001 C CNN
	1    6860 975 
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 613708D9
P 6860 1115
F 0 "C1" H 6952 1161 50  0000 L CNN
F 1 "0.1uF" H 6952 1070 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 6860 1115 50  0001 C CNN
F 3 "~" H 6860 1115 50  0001 C CNN
	1    6860 1115
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 613708C5
P 6860 1280
F 0 "#PWR0110" H 6860 1030 50  0001 C CNN
F 1 "GND" H 6865 1107 50  0000 C CNN
F 2 "" H 6860 1280 50  0001 C CNN
F 3 "" H 6860 1280 50  0001 C CNN
	1    6860 1280
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61374D68
P 5265 1770
F 0 "#PWR0111" H 5265 1520 50  0001 C CNN
F 1 "GND" H 5270 1597 50  0000 C CNN
F 2 "" H 5265 1770 50  0001 C CNN
F 3 "" H 5265 1770 50  0001 C CNN
	1    5265 1770
	1    0    0    -1  
$EndComp
Wire Wire Line
	5265 1690 5265 1770
Text Label 4315 1390 0    50   ~ 0
SLEEP
Wire Wire Line
	4315 1390 4565 1390
Text Label 4315 1190 0    50   ~ 0
OUT2
Wire Wire Line
	4315 1190 4565 1190
$Comp
...
ADDR = 0x31
$Comp
L magnetic_sensor:SI7210-B-10-IM2 U1
U 1 1 6137CA3B
P 2325 4395
F 0 "U1" H 2580 4540 50  0000 C CNN
F 1 "SI7210-B-11-IM2" H 3310 3960 50  0000 C CNN
F 2 "BYTE_Sensors:SON40P140X160X40-8N-D" H 3375 4495 50  0001 L CNN
F 3 "https://www.silabs.com/documents/public/data-sheets/si7210-datasheet.pdf" H 3375 4395 50  0001 L CNN
F 4 "SI7210-B-11-IM2" H 3375 4095 50  0001 L CNN "manf#"
	1    2325 4395
	1    0    0    -1  
$EndComp
Text Notes 2960 4945 0    50   ~ 0
ADDR = 0x30
$Comp
...
Low(Push-pull)
Text Notes 2970 5010 0    50   ~ 0
Low(Open-drain)
Text Label 2110 4445 0    50   ~ 0
SCL
Wire Wire Line
	2110 4445 2325 4445
Text Label 2110 4595 0    50   ~ 0
SDA
Wire Wire Line
	2110 4595 2325 4595
...
U 1 1 613B7132
P 2925 5050
F 0 "#PWR0112" H 2925 4800 50  0001 C CNN
F 1 "GND" H 2930 4877 50  0000 C CNN
...
U 1 1 613C6D2F
P 2925 4020
F 0 "#PWR0118" H 2925 3870 50  0001 C CNN
F 1 "+3.3V" H 2940 4193 50  0000 C CNN
F 2 "" H 2925 4020 50  0001 C CNN
F 3 "" H 2925 4020 50  0001 C CNN
	1    2925 4020
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 613FDA44
P 3385 3685
F 0 "#PWR?" H 3385 3535 50  0001 C CNN
F 1 "+3.3V" H 3400 3858 50  0000 C CNN
F 2 "" H 3385 3685 50  0001 C CNN
F 3 "" H 3385 3685 50  0001 C CNN
	1    3385 3685
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 613FDA4E
P 3385 3825
F 0 "C?" H 3477 3871 50  0000 L CNN
F 1 "0.1uF" H 3477 3780 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 3385 3825 50  0001 C CNN
F 3 "~" H 3385 3825 50  0001 C CNN
	1    3385 3825
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 613FDA58
P 3385 3990
F 0 "#PWR?" H 3385 3740 50  0001 C CNN
F 1 "GND" H 3390 3817 50  0000 C CNN
F 2 "" H 3385 3990 50  0001 C CNN
F 3 "" H 3385 3990 50  0001 C CNN
	1    3385 3990
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 6140C4E9
P 5150 3685
F 0 "#PWR?" H 5150 3535 50  0001 C CNN
...
U 1 1 6140C4F3
P 5150 3825
F 0 "C?" H 5242 3871 50  0000 L CNN
...
U 1 1 6140C4FD
P 5150 3990
F 0 "#PWR?" H 5150 3740 50  0001 C CNN
...
U 1 1 614205AE
P 7130 3630
F 0 "#PWR?" H 7130 3480 50  0001 C CNN
...
U 1 1 614205B8
P 7130 3770
F 0 "C?" H 7222 3816 50  0000 L CNN
...
U 1 1 614205C2
P 7130 3935
F 0 "#PWR?" H 7130 3685 50  0001 C CNN
...
U 1 1 61428F42
P 8955 3685
F 0 "#PWR?" H 8955 3535 50  0001 C CNN
...
U 1 1 61428F4C
P 8955 3825
F 0 "C?" H 9047 3871 50  0000 L CNN
...
U 1 1 61428F56
P 8955 3990
F 0 "#PWR?" H 8955 3740 50  0001 C CNN
